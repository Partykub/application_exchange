...
class GuestHistoryProfile extends StatefulWidget {
  final String userId;
  const GuestHistoryProfile({super.key, required this.userId});

  @override
  State<GuestHistoryProfile> createState() => _GuestHistoryProfileState();
}

class _GuestHistoryProfileState extends State<GuestHistoryProfile> {
                                    ...
                                    children: [
                                      ...
                                      RatingBar.builder(
                                        initialRating: rating
                                            .toDouble(), // ตัวเลข double ที่ใช้แสดงดาว
                                        minRating: 1,

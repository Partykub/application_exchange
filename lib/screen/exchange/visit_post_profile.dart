...
class VisitPostProfile extends StatefulWidget {
  final String userId;

  const VisitPostProfile({Key? key, required this.userId}) : super(key: key);

  @override
  State<VisitPostProfile> createState() => _VisitPostProfileState();
}

class _VisitPostProfileState extends State<VisitPostProfile> {
  @override
                  ...
                  return GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => VisitDetailPost(
                              postId: post.id,
                            ),
                          ));
                    },
